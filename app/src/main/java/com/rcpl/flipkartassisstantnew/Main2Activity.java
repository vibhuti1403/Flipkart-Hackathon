...
import com.rcpl.flipkartassisstantnew.ExpandableListAdapter;
...
public class Main2Activity extends Activity {
    ...
    private void prepareListData() {
        ...
        Accessories.add("Necklaces");


        List<String> Footwear = new ArrayList<String>();
        Footwear.add("Shoes");
        ...
        listDataChild.put(listDataHeader.get(1), Accessories);
        listDataChild.put(listDataHeader.get(2), Footwear);
    }
}
